...
const mockBuyerProfile = {
  ...
  fundingSource: 'combination' as const,
  ...
  preferredBusinessSize: 'medium' as const
};
...
export const Dashboard: React.FC = () => {
  ...
  const handleAccept = () => {
    alert('Connected with buyer! You can now start the acquisition process.');
  };

  const handleReject = () => {
    alert('Buyer rejected. Looking for more matches...');
  };

  const handleViewDetails = () => {
    alert('Opening detailed buyer profile...');
  };
